...
export interface UseFetchHostWithFieldPairParams {
  /**
   *
   */
  field: string;
...
export interface UseFetchHostWithFieldPairValue {
  /**
   *
   */
  loading: boolean;
...
const ALERT_PREVALENCE_AGG = 'countOfHostsWithSameFieldValuePair';

/**
 * Hook to retrieve threat intelligence data for the expandable flyout right and left sections.
 */
export const useFetchHostWithFieldPair = ({
  field,
  values,
  isActiveTimelines,
  indexName,
}: UseFetchHostWithFieldPairParams): UseFetchHostWithFieldPairValue => {
