...
export const INSIGHTS_PREVALENCE_LOADING_TEST_ID = `${INSIGHTS_PREVALENCE_TEST_ID}Loading`;
export const INSIGHTS_PREVALENCE_ICON_TEST_ID = `${INSIGHTS_PREVALENCE_TEST_ID}Icon`;
export const INSIGHTS_PREVALENCE_VALUE_TEST_ID = `${INSIGHTS_PREVALENCE_TEST_ID}Value`;
export const INSIGHTS_PREVALENCE_COLOR_TEST_ID = `${INSIGHTS_PREVALENCE_TEST_ID}Color`;
